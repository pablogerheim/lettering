      ...
      <div className={!open ? "direction" : "opacity"}>
        ...
        <section className="card-2">
          <div className="flex2">
            ...
            <p className="align-left text2">
              Esse é um treinamento passo a passo, onde você aprende lettering
              100% online. São mais de 90 aulas gravadas para você assistir no
              seu tempo, de onde quiser. Após a inscrição o acesso a plataforma
              chegará no seu e-mail.
            </p>
          </div>
        </section>
            ...
            <div className="box150">
              <div className="icon3">
                <svg
                  ...
                  viewBox="0 0 59.9 60"
                >
                  <path d="M0,25.54v-.23c.21-1.04,.9-1.59,1.86-1.97,2.55-1.01,5.08-2.09,7.62-3.13,1.19-.49,2.28-.03,2.79,1.15,.38,.88,.73,1.76,1.09,2.65,1.36,3.29,2.72,6.59,4.1,9.88,.07,.17,.3,.43,.43,.41,.67-.07,1.33-.21,2.03-.33-.02-.13-.02-.25-.05-.36-1.37-5.86-2.76-11.72-4.12-17.59-.36-1.57-.85-3.1-.74-4.77,.18-2.78,.24-5.57,.33-8.36,.05-1.73,.43-2.3,2-2.89h.7c.95,.26,1.52,.91,1.97,1.77,1.45,2.74,2.94,5.45,4.41,8.18,.16,.31,.32,.63,.4,.97,1.3,5.54,2.59,11.08,3.89,16.62,.29,1.24,.59,2.49,.89,3.76,.68-.47,1.28-.94,1.93-1.32,.42-.24,.59-.5,.57-1-.15-3.48,.13-6.94,.65-10.38,.04-.28-.08-.66-.26-.88-2.25-2.88-1.74-6.19,.26-8.32,1.23-1.31,2.24-2.84,3.22-4.36,.67-1.03,.9-2.25,.58-3.49-.17-.68,0-1.18,.57-1.55h.7c1.59,1.28,2.94,2.78,4.08,4.47,2.99,4.45,3.25,9.5-.03,13.78-.12,.15-.15,.39-.16,.59-.09,2.42-.16,4.84-.27,7.25-.03,.71-.15,1.42-.23,2.08l3.61,1.3c1.04-2.59,2.14-5.17,3.1-7.81,.42-1.18,.58-2.46,.77-3.71,.11-.7,.37-1.19,.97-1.56,2.18-1.34,4.34-2.7,6.51-4.05,1.02-.63,1.64-.37,1.91,.79,.56,2.45,1.12,4.91,1.71,7.35,.18,.75,.07,1.36-.44,1.95-1.17,1.38-2.07,2.93-2.76,4.6-1.58,3.8-3.14,7.6-4.69,11.41-.1,.26-.12,.56-.12,.85,.02,1.24,.07,2.49,.09,3.73,0,.3-.07,.61-.11,.93,.27,.02,.48,.05,.69,.06,4.32,.34,7.52,3.94,7.39,8.3-.13,4.18-3.65,7.65-7.89,7.65-14.71,.02-29.41,.02-44.12,0-3.58,0-6.74-2.55-7.61-6C.16,53.61,.09,53.23,0,52.85c0-.59,0-1.17,0-1.76,.04-.11,.09-.21,.11-.32,.51-2.86,2.09-4.92,4.74-6.09,.82-.36,1.74-.52,2.66-.78-.05-.14-.12-.33-.2-.52-.78-1.89-1.57-3.78-2.35-5.67-1.66-4.05-3.31-8.11-4.97-12.16ZM30.01,58c7.32,0,14.64,.02,21.97,0,3.57-.01,6.34-3.06,6-6.51-.35-3.58-3.58-6.02-7.14-5.38-1.02,.18-1.57-.41-1.29-1.43,.47-1.74,.56-3.49,.26-5.28-1.04-6.12-7.28-10.45-13.36-9.23-4.11,.83-6.99,3.2-8.63,7.06-.18,.42-.4,.83-.88,.82-.36-.01-.75-.18-1.06-.39-3.74-2.54-8.72-2.15-11.96,.99-1.82,1.76-2.78,3.92-2.91,
21,0-.28-.53-1.01-1.08-2.01-1.64-3.05-1.18,.94-2.48,1.17-3.91,.96Zm17,14.94v4.76l5.12-.72,.39-3.71-5.52-.33Zm5.61-4.68l-5.02-.29-.36,3,5.38,.28v-2.98ZM20.06,6.14c-.07-.14-.12-.29-.2-.42-.62-1.15-1.24-2.3-1.87-3.44-.06-.11-.3-.26-.35-.22-.13,.08-.26,.25-.27,.39-.06,1.36-.11,2.73-.13,4.1,0,.12,.2,.33,.34,.35,.93,.15,1.78-.05,2.49-.75Z"></path>
                  <path d="M24.28,50.04c.1-2.51,1.65-4.73,4-5.62,2.32-.88,4.94-.23,6.6,1.67,.26,.3,.44,.36,.82,.22,2.32-.85,4.91,.15,6.06,2.32,.36,.69,.25,1.28-.3,1.57-.53,.28-1.06,.06-1.44-.59-.96-1.63-2.78-2.09-4.32-1.1-.87,.56-1.32,.45-1.84-.46-.95-1.66-2.79-2.42-4.61-1.89-1.79,.51-2.99,2.2-2.87,4.07,.03,.44,.17,.88,.29,1.3,.19,.67-.02,1.22-.58,1.4-.56,.19-1.1-.08-1.31-.75-.22-.7-.35-1.43-.52-2.14Z"></path>
                  <path d="M37.98,32.98c0,.59-.37,.95-1.05,1.01-1.59,.13-2.81,.86-3.59,2.28-.17,.3-.26,.65-.39,.97-.22,.58-.69,.85-1.23,.71-.52-.14-.79-.64-.68-1.25,.47-2.53,3.36-4.82,5.92-4.71,.6,.03,1.01,.43,1.02,.99Z"></path>
                  <path d="M17.9,39c.57,0,.91,.24,1.05,.7,.14,.46,0,.85-.41,1.12-.19,.13-.43,.19-.63,.3-1.06,.55-1.69,1.41-1.87,2.59-.02,.13-.03,.27-.06,.4-.12,.57-.54,.92-1.07,.87-.53-.05-.9-.46-.9-1.04,0-1.04,.29-2,.91-2.84,.67-.92,1.56-1.57,2.62-1.99,.14-.06,.3-.09,.37-.11Z"></path>
                  <path d="M40.94,10.68c0,1.71-.43,3.12-1.3,4.39-.43,.63-.96,.79-1.48,.47-.53-.33-.61-.94-.17-1.58,.85-1.26,1.08-2.64,.89-4.12-.08-.62,.26-1.07,.81-1.16,.56-.09,.99,.22,1.14,.83,.03,.13,.06,.27,.07,.4,.03,.31,.04,.62,.05,.77Z"></path>
                </svg>{" "}
              </div>{" "}
              <p className="left">
                Nunca fez lettering mas tem vontade de aprender.
            ...
            <div className="box150">
              <div className="icon3">
                <svg
                  ...
                  viewBox="0 0 61.4 58"
                >
                  <path d="M0,47.2c.36-.21,.71-.54,1.1-.62,.92-.19,1.5-.63,1.6-1.6,.02-.15,.09-.31,.15-.45,.3-.76,1.2-.96,1.58-.26,.64,1.16,1.48,1.59,2.79,1.43,.78-.1,1.25,.85,.71,1.42-.91,.96-1.05,1.9-.5,3.09,.33,.71-.42,1.43-1.13,1.1-1.16-.55-2.12-.48-3.04,.46-.18,.18-.72,.22-.96,.08-.25-.13-.51-.58-.47-.85,.18-1.23-.19-2.11-1.35-2.64-.19-.08-.32-.28-.47-.43,0-.24,0-.48,0-.72Zm3.15,.73l.56,1.15,1.3-.2,.18-1.28-1.16-.63-.88,.96Z"></path>
                  <path d="M21.32,7.78c.3-.89-.22-1.5-1.09-1.94-.28-.14-.58-.32-.77-.56-.22-.27-.48-.66-.44-.94,.05-.29,.42-.61,.73-.75,.54-.25,1.15-.34,1.7-.57,.23-.1,.47-.34,.57-.58,.23-.57,.32-1.2,.57-1.76,.13-.29,.44-.62,.72-.67,.28-.05,.62,.23,.92,.37,.06,.03,.11,.12,.14,.19,.65,1.49,1.8,1.97,3.35,1.68,.46-.09,.88,.05,1.11,.52,.21,.44,.02,.8-.25,1.16-.42,.56-1.06,1.09-1.15,1.71-.1,.61,.35,1.32,.58,1.97,.16,.44,.24,.85-.13,1.22-.37,.37-.82,.34-1.22,.12-1.39-.76-2.58-.58-3.65,.6-.31,.34-.72,.52-1.19,.29-.48-.23-.53-.66-.51-1.12,.01-.26,0-.52,0-.93Zm.61-3.04c.43,.39,.87,.64,1.06,1.01,.2,.38,.15,.89,.2,1.32,.43-.23,.8-.57,1.22-.63,.41-.06,.87,.14,1.43,.26-.65-.98-.44-1.82,.35-2.57-.58-.06-1.08,0-1.45-.18-.38-.2-.64-.64-1.07-1.11,.01,1.27-.69,1.76-1.76,1.91Z"></path>
                  <path d="M39.72,53.08c.08-.54,.2-1.09,.24-1.64,.02-.23-.08-.53-.24-.71-.32-.38-.72-.69-1.07-1.05-.55-.58-.31-1.37,.47-1.56,.33-.08,.67-.16,1-.16,.71,0,1.14-.31,1.35-.99,.11-.34,.28-.66,.47-.97,.38-.63,1.19-.63,1.57,0,.27,.46,.47,.97,.75,1.43,.1,.17,.33,.33,.52,.38,.48,.11,1,.1,1.47,.25,.31,.1,.71,.33,.79,.59,.09,.29-.08,.72-.26,1.01-.21,.33-.52,.6-.84,.85-.41,.32-.47,.69-.35,1.15,.1,.4,.18,.82,.22,1.24,.08,.81-.65,1.4-1.29,.94-1.23-.87-2.31-.79-3.5,.05-.56,.39-1.3-.12-1.31-.8Zm3.05-4.34l-1.31,.94,.51,1.55h1.73c-.21-.62,.02-1.15,.45-1.49l-1.38-1.01Z"></path>
                  <path d="M54.2,13.29c1.39,.64,2.24,.04,2.98-1.01,.15-.22,.65-.37,.93-.3,.27,.07,.63,.45,.65,.72,.09,1.3,.71,2.04,1.98,2.37,.27,.07,.59,.52,.62,.82,.03,.27-.25,.73-.51,.83-1.22,.48-1.71,1.32-1.63,2.61,.02,.26-.3,.67-.56,.8-.24,.11-.76,.04-.91-.15-.88-1.07-1.88-1.24-3.15-.76-.69,.26-1.37-.56-1-1.2,.68-1.16,.71-2.18-.2-3.23-.16-.19-.14-.69,0-.93,.15-.26,.53-.39,.81-.57Zm1.94,3.6l1.35,.34,.75-1.15-.88-1.08-1.32,.53,.1,1.36Z"></path>
                  <path d="M44.59,20.36c5.03,.31,9.57,2.02,13.74,4.79,.85,.56,1.66,1.18,2.47,1.8,.66,.5,.76,.97,.37,1.45-.38,.47-.84,.46-1.46-.03-3.13-2.48-6.55-4.43-10.45-5.41-1.56-.39-3.18-.57-4.77-.79-.83-.11-1.21-.34-1.19-.94,.02-.63,.43-.91,1.29-.87Z"></path>
                  <path d="M32.32,11.81c-.93,0-1.36-.75-.97-1.39,.82-1.34,1.6-2.72,2.59-3.94,.91-1.12,2.04-2.06,3.12-3.04,.56-.5,1.11-.45,1.45,.03,.33,.45,.21,.95-.36,1.38-2.2,1.65-3.82,3.77-5.11,6.17-.19,.35-.55,.6-.72,.79Z"></path>
                  <path d="M6.62,22.25c-.09,.11-.22,.4-.44,.54-1.66,.99-3.12,2.22-4.45,3.61-.4,.42-.92,.41-1.28,.06-.36-.36-.39-.89-.02-1.29,1.42-1.53,3-2.86,4.82-3.9,.68-.39,1.38,.04,1.36,.98Z"></path>
                  <path d="M12.18,47.32c-.55-.01-.98-.5-.85-1.07,.25-1.15,.53-2.29,.84-3.42,.15-.54,.64-.78,1.12-.64,.49,.15,.72,.64,.58,1.21-.26,1.04-.52,2.09-.78,3.13-.13,.51-.46,.8-.91,.79Z"></path>
                  <path d="M58.39,40.78c0,.5-.35,.89-.84,.91-.5,.02-.87-.33-.89-.85-.03-.54,.34-.94,.86-.94,.48,0,.86,.38,.87,.88Z"></path>
                  <path d="M5.35,13.46c.03-.51,.39-.84,.91-.81,.49,.02,.83,.41,.81,.91-.02,.53-.43,.9-.94,.85-.49-.04-.81-.44-.78-.95Z"></path>
                  <path d="M45.82,5.11c-.01,.52-.35,.86-.87,.86-.53,0-.87-.38-.84-.94,.02-.51,.4-.87,.89-.84,.49,.02,.83,.41,.81,.92Z"></path>
                  <path d="M29.19,45.82c.49,.01,.84,.38,.83,.9,0,.52-.34,.87-.85,.88-.53,0-.89-.38-.87-.92,.02-.51,.39-.87,.89-.86Z"></path>
                  <path d="M53.89,28.75c.01,.51-.34,.9-.82,.92-.5,.02-.9-.38-.9-.91,0-.51,.36-.87,.86-.88,.51,0,.85,.34,.86,.86Z"></path>
                  <path d="M12.18,55.77c-.49-.01-.84-.38-.83-.9,0-.52,.35-.87,.85-.87,.52,0,.89,.39,.87,.93-.02,.51-.4,.86-.89,.85Z"></path>
                </svg>{" "}
              </div>{" "}
              <p className="left">
                Nunca fez lettering mas tem vontade de aprender.
        ...
        <div className="card-6">
          <h3 className="card6-h3 align-left">
          ...
          <div className="box9">
            ...
            <div className="flex9">
              ...
              <div>
                ...
                <p className="align-left">
                  <span className="title9 ">Bônus 2: Decoração Plus</span>
                  <br />
                  <span>
        ...
        <section className="card-10" id="garantirVaga">
          <div className="box10">
            <p>
              <b className="title10">GARANTA SUA VAGA</b>
              <span>
                <br />
              </span>
            </p>
            <p>
              <b className="subtitle10">COMECE AGORA E RECEBA</b>
              <span>
                <br />
              </span>
            </p>
            <div className="garantias10">
              {" "}
              {receba.map((r) => (
                <div key={v4()} className="flex10">
                  {" "}
        ...
        <section className="card-13">
          <div className="flex13">
            ...
            <div>
              {" "}
              {professora.map((p) => (
                <p className="professora align-left" key={v4()}>
                  {" "}
                  {p}
                </p>
              ))}
                ...
                <div key={v4()}>
                  <div className="flex-17">
                    ...
                    >
                      ...
                      <p
                        className={
                          !isHiddenPergunta(p.id) ? `text17` : "text172"
                        }
                      >
                  ...
                  <p className={!isHiddenPergunta(p.id) ? `hidden` : "p17"}>
                    {p.text}
                  </p>
                </div>
              ))}
        ...
        <a
          className="linkwwapp"
          href="https://api.whatsapp.com/send?phone=5532988468403&text=Tenho%20interesse%20no%20curso%20Lettering%20na%20Prática.%20Pode%20me%20ajudar?"
          target="_blank"
        >
          <img
            alt="WhatsApp"
            className="imgwwapp"
            src="https://camilapegado.com.br/wp-content/uploads/2022/02/whatsapp-icone-2-1020x1024-1.png"
          />
        </a>
        <footer>
          <p className="footer">
            Camila Pegado | Lettering na Prática © Todos os Direitos Reservados
          </p>
        </footer>
      </div>
    </>
