...
function App() {
  ...
  return (<>
    {!open || <UpdateDialog setOpen={setOpen}
      current_path={searchParams.get("src")}
    />}
    <div className={!open ? "direction" : "opacity"}>
      ...
      <section className='card-10' id='garantirVaga'>
        <div className='box10'>
          ...
          <div className='button10'>
            <button onClick={() => setOpen(true)} className='add-to-cart buttonSub'>SIM! EU QUERO COMEÇAR AGORA</button>
          </div>
      ...
      <a className='linkwwapp' href="https://api.whatsapp.com/send?phone=5532988468403&text=Tenho%20interesse%20no%20curso%20Lettering%20na%20Prática.%20Pode%20me%20ajudar?" target="_blank" >
